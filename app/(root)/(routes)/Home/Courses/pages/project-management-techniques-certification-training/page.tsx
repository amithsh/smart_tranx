          ...
          <div className="flex flex-col">
            <div className="h-auto max-w-[700px]  ">
              ...
              <p className="font-medium text-lg opacity-90">
                Project Management revolves around achieving efficiency and
                effectiveness, and this workshop is designed to impart the
                knowledge of concepts, methodologies, and procedures that
                empower you to effectively lead projects and inspire your team.
                Throughout the course, you will discover how project management
                plays a pivotal role in driving organizational success across
                various stages, including project selection, initiation,
                planning, execution, and continuous monitoring and control.
              </p>
            </div>
